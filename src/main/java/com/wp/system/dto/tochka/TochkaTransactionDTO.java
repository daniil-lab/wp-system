...
import com.wp.system.dto.tinkoff.TinkoffTransactionAmountDTO;
...
public class TochkaTransactionDTO {
    private UUID id;

    private String status;

    private TochkaTransactionAmountDTO amount;
    ...
    public TochkaTransactionDTO() {}

    public TochkaTransactionDTO(TochkaTransaction t) {
        if(t == null)
            return;

        this.id = t.getId();
        this.status = t.getStatus();
        this.amount = t.getAmount() == null ? null : new TochkaTransactionAmountDTO(t.getAmount());
    ...
    public TochkaTransactionAmountDTO getAmount() {
        return amount;
    }

    public void setAmount(TochkaTransactionAmountDTO amount) {
        this.amount = amount;
    }
