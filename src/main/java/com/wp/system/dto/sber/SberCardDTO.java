...
public class SberCardDTO {
    ...
    private SberCardBalanceDTO balance;
    ...
    public SberCardDTO(SberCard c) {
        ...
        this.id = c.getId();
        this.balance = new SberCardBalanceDTO(c.getBalance());
    ...
    public SberCardBalanceDTO getBalance() {
        return balance;
    }

    public void setBalance(SberCardBalanceDTO balance) {
