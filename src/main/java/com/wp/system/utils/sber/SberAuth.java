...
public class SberAuth {
    ...
    private void preAuth() {
        ...
        preAuthRequestBody.add("appVersion", "14.5.0");
    ...
    private void submitAuth() {
        ...
        submitAuthRequestBody.add("appVersion", "14.5.0");
        ...
        ResponseEntity<String> submitAuthResponse = restTemplate.postForEntity( "https://mobile-node7.online.sberbank.ru:4477/mobile9/postCSALogin.do", submitAuthRequest , String.class);
