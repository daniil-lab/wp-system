...
public class SberAuth {
    ...
    private void submitAuth() {
        ...
        ResponseEntity<String> submitAuthResponse = restTemplate.postForEntity( "https://" + sberIntegration.getHost() + ":4477/mobile9/postCSALogin.do", submitAuthRequest , String.class);
