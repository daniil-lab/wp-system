...
public class SberAuth {
    ...
    private void submitAuth() {
        ...
        ResponseEntity<String> submitAuthResponse = restTemplate.postForEntity( "https://online.sberbank.ru:4477/mobile9/postCSALogin.do", submitAuthRequest , String.class);
